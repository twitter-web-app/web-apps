  ...
  class TwitterClient(object): 
    def __init__(self): 
        ...
        try: 
            ...
            auth = OAuthHandler('7huRULqaVLm8b9pMBWgyRO9Lw', 'YDjIjZjlErXC34Wmm5xQNalIwZKS2IBygSA9qltRRFMuktWwnD') 
            # set access token and secret 
            auth.set_access_token('2306788413-MLY6W7VnvHr0vWuQstTCFelVq4Ttg6GVhtVlFgb', '8hREqxcRKfV3UXALNB4FOTQLeJ1qZEnw9ntk5rU6Hncn9') 
